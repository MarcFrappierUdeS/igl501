/* Selection sort
   version v2
   la spécification vérifie que le vecteur final est trié et que
   le vecteur de sortie est une permutaiton du vecteur d'entrée
   la version v0 ne fait pas cette vérification
*/
